...
public class Driver {
	// Create a static instance of AppEngine
	private static AppEngine appEngine = new AppEngine();
	/**
	...
	public static String getClient(String email) {
		return appEngine.getClient(email).toString();
	}
	...
	public static String getFlights(String date, String origin, String destination) {
		return appEngine.searchFlights(date, origin, destination);
	}
	...
	public static String getItineraries(String date, String origin, String destination) {
		return appEngine.textListItineraries(
				appEngine.getItineraries(date, origin, destination));
	}
	...
	public static String getItinerariesSortedByCost(String date, String origin, String destination) {
		return appEngine.textListItineraries(
				appEngine.sortByCost(appEngine.getItineraries(date, 
						origin, destination)));
	}
	...
	public static String getItinerariesSortedByTime(String date, String origin, String destination) {
		return appEngine.textListItineraries(
				appEngine.sortByTime(appEngine.getItineraries(date, 
						origin, destination)));
	}
}
